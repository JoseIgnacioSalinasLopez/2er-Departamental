...
export default function Checkout() {
  ...
  const continuarAPago = () => {
    if (!direccionSeleccionada) {
      alert('⚠️ Por favor selecciona o agrega una dirección de envío')
      return
    }
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            <div style={{ gridColumn: 'span 2' }}>
              <div style={{ backgroundColor: '#ffffff', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', padding: '24px', marginBottom: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
                  <h2 style={{ fontSize: '24px', fontWeight: 'bold' }}>Dirección de Envío</h2>
                  <button
                ...
                {mostrarFormulario && (
                  <form onSubmit={guardarDireccion} style={{ marginBottom: '24px', padding: '16px', backgroundColor: '#f9fafb', borderRadius: '4px', border: '1px solid #e5e7eb' }}>
                    <h3 style={{ fontWeight: '600', marginBottom: '16px' }}>Agregar Nueva Dirección</h3>
                        ...
                        <div style={{ display: 'flex', alignItems: 'start', gap: '12px' }}>
                          ...
                          <div style={{ flexGrow: 1 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              <p style={{ fontWeight: '600' }}>{dir.linea_direccion_1}</p>
                            ...
                            {dir.linea_direccion_2 && (
                              <p style={{ fontSize: '14px', color: '#6b7280' }}>{dir.linea_direccion_2}</p>
                            )}
                            <p style={{ fontSize: '14px', color: '#6b7280' }}>
                              {dir.ciudad}, {dir.estado} {dir.codigo_postal}
                            </p>
                            <p style={{ fontSize: '14px', color: '#6b7280' }}>{dir.pais}</p>
                          </div>
                        </div>
                      </label>
                    ))
            ...
            <div>
              <div style={{ backgroundColor: '#ffffff', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)', padding: '24px', position: 'sticky', top: '16px' }}>
                <h3 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '16px' }}>Resumen del Pedido</h3>
                ...
                <button
                  onClick={() => navigate('/carrito')}
                  style={{ width: '100%', marginTop: '12px', padding: '12px 24px', backgroundColor: '#e5e7eb', color: '#374151', borderRadius: '8px', border: 'none', cursor: 'pointer', fontWeight: '600' }}
                >
                  Volver al Carrito
                </button>
              </div>
